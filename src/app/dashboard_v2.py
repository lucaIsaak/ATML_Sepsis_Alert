"""
SepsisAlert — Streamlit ICU Dashboard  (v2 — Shadcn UI experiment).
...
------------------------------
  • KPI row           → streamlit_shadcn_ui metric_card
  • Risk badges       → streamlit_shadcn_ui badge
  • Action buttons    → streamlit_shadcn_ui button
  • Feedback banners  → streamlit_shadcn_ui alert
  • Patient header    → streamlit_shadcn_ui card
  • Model stats KPIs  → streamlit_shadcn_ui metric_card
"""
