...
> **This is a research prototype built without access to real hospital data.**
> The demo runs entirely on synthetic ICU data generated by `setup_demo.py` — no real patient records are used or required.
