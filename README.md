...
> Full evaluation methodology: [EVALUATION_GUIDE.md](EVALUATION_GUIDE.md) · Model details: [MODEL_CARD.md](MODEL_CARD.md) · Demo Video in case the setup takes too long: [UI-Demo](https://www.youtube.com/watch?v=pH3xdFhUCRA&feature=youtu.be)
